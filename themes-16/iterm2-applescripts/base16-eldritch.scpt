...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {12850, 13364, 18761}
        ...
        set ANSI white color to {61680, 62194, 62708}

        -- Set Bright ANSI Colors
        set ANSI bright black color to {15163, 16962, 24929}
        set ANSI bright red color to {61937, 27756, 30069}
        set ANSI bright green color to {14135, 62708, 39321}
        set ANSI bright yellow color to {61937, 64764, 31097}
        set ANSI bright blue color to {14649, 56797, 65021}
        set ANSI bright magenta color to {42148, 35980, 62194}
