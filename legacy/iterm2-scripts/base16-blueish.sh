...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {63222, 43176, 23644}
        set ANSI bright green color to {9252, 15420, 21588}
        set ANSI bright yellow color to {17990, 10537, 2570}
        set ANSI bright blue color to {29812, 44975, 59367}
        set ANSI bright magenta color to {56797, 60138, 63222}
        set ANSI bright cyan color to {48059, 53970, 59624}
