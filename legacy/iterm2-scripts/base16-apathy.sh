...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {15934, 31097, 38550}
        set ANSI bright green color to {2827, 13364, 11565}
        set ANSI bright yellow color to {6168, 20046, 17733}
        set ANSI bright blue color to {24415, 40092, 37522}
        set ANSI bright magenta color to {42919, 52942, 51400}
        set ANSI bright cyan color to {15934, 38550, 23387}
