...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {15163, 16962, 21074}
        set ANSI bright yellow color to {17219, 19532, 24158}
        set ANSI bright blue color to {55512, 57054, 59881}
        set ANSI bright magenta color to {60652, 61423, 62708}
        set ANSI bright cyan color to {24158, 33153, 44204}
