...
# Scheme name: Tokyo Night Terminal Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {38550, 20560, 10023}
        set ANSI bright green color to {52171, 52428, 53713}
        set ANSI bright yellow color to {57311, 57568, 58853}
        set ANSI bright blue color to {19532, 20560, 24158}
        set ANSI bright magenta color to {6682, 6939, 9766}
        set ANSI bright cyan color to {25957, 21074, 22873}
