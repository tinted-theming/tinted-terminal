...
# Scheme name: Atelier Lakeside (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {7967, 10537, 11822}
        ...
        set ANSI bright green color to {7967, 10537, 11822}
        set ANSI bright yellow color to {20817, 28013, 31611}
        set ANSI bright blue color to {29041, 38293, 43176}
        set ANSI bright magenta color to {49601, 58596, 63222}
