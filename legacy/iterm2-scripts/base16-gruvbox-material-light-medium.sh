...
# Scheme name: Gruvbox Material Light, Medium (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {50115, 24158, 2570}
        set ANSI bright green color to {62194, 58853, 48316}
        set ANSI bright yellow color to {54741, 50372, 41377}
        set ANSI bright blue color to {26214, 23644, 21588}
        set ANSI bright magenta color to {15420, 14392, 13878}
        set ANSI bright cyan color to {59367, 35466, 20046}
