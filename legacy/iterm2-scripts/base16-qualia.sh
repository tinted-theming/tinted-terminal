...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {17733, 17733, 17733}
        ...
        set ANSI bright red color to {41891, 47288, 61423}
        set ANSI bright green color to {17733, 17733, 17733}
        set ANSI bright yellow color to {17733, 17733, 17733}
        set ANSI bright blue color to {32896, 32896, 32896}
        set ANSI bright magenta color to {49344, 49344, 49344}
        set ANSI bright cyan color to {32896, 32896, 32896}
