...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {10794, 5397, 15420}
        ...
        set ANSI bright red color to {60138, 19789, 24672}
        set ANSI bright green color to {10794, 5397, 15420}
        set ANSI bright yellow color to {19275, 8224, 21588}
        set ANSI bright blue color to {35980, 16448, 28527}
        set ANSI bright magenta color to {50372, 26728, 28013}
        set ANSI bright cyan color to {39064, 19789, 20817}
