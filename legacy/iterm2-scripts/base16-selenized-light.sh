...
# Scheme name: selenized-light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {48316, 22616, 6425}
        set ANSI bright green color to {60652, 58339, 52428}
        set ANSI bright yellow color to {54741, 52685, 46774}
        set ANSI bright blue color to {37008, 39321, 38293}
        set ANSI bright magenta color to {14906, 19789, 21331}
        set ANSI bright cyan color to {50372, 17219, 37522}
