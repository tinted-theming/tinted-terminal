...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {51914, 32639, 12850}
        set ANSI bright green color to {12336, 11051, 9509}
        set ANSI bright yellow color to {18504, 16705, 14906}
        set ANSI bright blue color to {46260, 42148, 37008}
        set ANSI bright magenta color to {55255, 51400, 48316}
        set ANSI bright cyan color to {46260, 37779, 26728}
