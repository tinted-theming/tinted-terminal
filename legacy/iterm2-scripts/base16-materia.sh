...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {11308, 14649, 16191}
        ...
        set ANSI bright red color to {60138, 38293, 24672}
        set ANSI bright green color to {11308, 14649, 16191}
        set ANSI bright yellow color to {14135, 18247, 20303}
        set ANSI bright blue color to {51657, 52428, 54227}
        set ANSI bright magenta color to {54741, 56283, 58853}
        set ANSI bright cyan color to {60652, 24415, 26471}
