...
# Scheme name: Unikitty Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {57825, 57825, 58082}
        ...
        set ANSI bright red color to {54998, 21588, 1799}
        set ANSI bright green color to {57825, 57825, 58082}
        set ANSI bright yellow color to {50372, 50115, 50629}
        set ANSI bright blue color to {35209, 34695, 35723}
        set ANSI bright magenta color to {20303, 19275, 20817}
        set ANSI bright cyan color to {57568, 4883, 53456}
