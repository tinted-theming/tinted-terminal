...
# Scheme name: Atelier Heath (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {10537, 8995, 10537}
        set ANSI bright yellow color to {26985, 23901, 26985}
        set ANSI bright blue color to {40606, 36751, 40606}
        set ANSI bright magenta color to {55512, 51914, 55512}
