...
# Scheme name: Tokyo City Terminal Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {7453, 9509, 11308}
        set ANSI bright yellow color to {10280, 12850, 14906}
        set ANSI bright blue color to {47031, 50629, 54227}
        set ANSI bright magenta color to {63222, 63222, 63736}
        set ANSI bright cyan color to {56797, 40349, 33410}
