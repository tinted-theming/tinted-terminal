...
# Scheme name: London Tube (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {62451, 34438, 41377}
        set ANSI bright green color to {7196, 16191, 38293}
        set ANSI bright yellow color to {23130, 22359, 22616}
        set ANSI bright blue color to {38293, 40092, 41377}
        set ANSI bright magenta color to {59367, 59367, 59624}
        set ANSI bright cyan color to {45232, 24929, 4112}
