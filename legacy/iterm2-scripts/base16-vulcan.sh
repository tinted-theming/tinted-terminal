...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {4626, 8995, 14649}
        ...
        set ANSI bright red color to {37265, 39064, 41891}
        set ANSI bright green color to {4626, 8995, 14649}
        set ANSI bright yellow color to {0, 13621, 21074}
        set ANSI bright blue color to {27499, 26985, 30583}
        set ANSI bright magenta color to {13107, 12850, 14392}
