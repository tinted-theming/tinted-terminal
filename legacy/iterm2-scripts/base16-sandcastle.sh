...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {41120, 32382, 15163}
        set ANSI bright green color to {11308, 12850, 15163}
        set ANSI bright yellow color to {15934, 17476, 20817}
        set ANSI bright blue color to {37522, 33667, 29812}
        set ANSI bright magenta color to {54741, 50372, 41377}
        set ANSI bright cyan color to {43176, 29555, 8738}
