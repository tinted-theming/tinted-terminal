...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {17219, 33410, 3341}
        set ANSI bright green color to {7196, 13878, 22359}
        set ANSI bright yellow color to {10794, 13364, 14906}
        set ANSI bright blue color to {33924, 35209, 35980}
        set ANSI bright magenta color to {42919, 53199, 41891}
        set ANSI bright cyan color to {51657, 33667, 17476}
