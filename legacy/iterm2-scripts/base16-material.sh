...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {11822, 15420, 17219}
        ...
        set ANSI bright red color to {63479, 35980, 27756}
        set ANSI bright green color to {11822, 15420, 17219}
        set ANSI bright yellow color to {12593, 17733, 18761}
        set ANSI bright blue color to {45746, 52428, 54998}
        set ANSI bright magenta color to {61166, 65535, 65535}
        set ANSI bright cyan color to {65535, 21331, 28784}
