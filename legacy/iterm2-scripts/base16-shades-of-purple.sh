...
# Scheme name: Shades of Purple (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {17219, 54484, 9766}
        ...
        set ANSI bright red color to {63993, 10794, 7196}
        set ANSI bright green color to {17219, 54484, 9766}
        set ANSI bright yellow color to {61937, 53456, 0}
        set ANSI bright blue color to {26728, 29041, 65535}
        set ANSI bright magenta color to {65535, 30583, 65535}
        set ANSI bright cyan color to {31097, 59624, 64507}
