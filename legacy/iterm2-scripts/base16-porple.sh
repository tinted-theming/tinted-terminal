...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {53970, 36494, 23901}
        set ANSI bright green color to {13107, 13107, 17476}
        set ANSI bright yellow color to {18247, 16705, 24672}
        set ANSI bright blue color to {47288, 47288, 47288}
        set ANSI bright magenta color to {59624, 59624, 59624}
        set ANSI bright cyan color to {39064, 26728, 16705}
