...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {4883, 4883, 14906}
        set ANSI bright yellow color to {8995, 9509, 23130}
        set ANSI bright blue color to {19018, 21074, 37779}
        set ANSI bright magenta color to {31097, 34438, 50629}
        set ANSI bright cyan color to {63479, 26728, 41891}
