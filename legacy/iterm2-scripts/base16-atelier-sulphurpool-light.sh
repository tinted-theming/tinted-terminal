...
# Scheme name: Atelier Sulphurpool Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {57311, 58082, 61937}
        ...
        set ANSI bright green color to {57311, 58082, 61937}
        set ANSI bright yellow color to {38807, 40349, 46260}
        set ANSI bright blue color to {27499, 29555, 38036}
        set ANSI bright magenta color to {10537, 12850, 22102}
