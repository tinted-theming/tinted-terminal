...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {37265, 34952, 35209}
        set ANSI bright green color to {4112, 771, 8995}
        set ANSI bright yellow color to {15934, 11565, 23644}
        set ANSI bright blue color to {48830, 48316, 49087}
        set ANSI bright magenta color to {60909, 60138, 61423}
        set ANSI bright cyan color to {22873, 12850, 23644}
