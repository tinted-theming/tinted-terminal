...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {52685, 43176, 26985}
        set ANSI bright green color to {12850, 13621, 14135}
        set ANSI bright yellow color to {17990, 19275, 20560}
        set ANSI bright blue color to {33667, 33153, 33924}
        set ANSI bright magenta color to {50115, 50115, 50115}
        set ANSI bright cyan color to {39835, 28784, 16191}
