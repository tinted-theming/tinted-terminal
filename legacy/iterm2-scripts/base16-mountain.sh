...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {52942, 45489, 34952}
        set ANSI bright green color to {6425, 6425, 6425}
        set ANSI bright yellow color to {9766, 9766, 9766}
        set ANSI bright blue color to {44204, 35466, 35980}
        set ANSI bright magenta color to {59367, 59367, 59367}
        set ANSI bright cyan color to {44204, 35466, 35980}
