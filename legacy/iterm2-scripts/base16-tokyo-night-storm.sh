...
# Scheme name: Tokyo Night Storm (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {43433, 45489, 54998}
        set ANSI bright green color to {5654, 5654, 7710}
        ...
        set ANSI bright cyan color to {63479, 30326, 36494}
