...
# Scheme name: Humanoid light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 15677, 0}
        set ANSI bright green color to {61423, 61423, 59881}
        set ANSI bright yellow color to {57054, 57054, 55512}
        set ANSI bright blue color to {24672, 24929, 23901}
        set ANSI bright magenta color to {12079, 13107, 14135}
