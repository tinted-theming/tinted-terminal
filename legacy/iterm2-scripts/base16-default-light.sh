...
# Scheme name: Default Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {56540, 38550, 22102}
        set ANSI bright green color to {59624, 59624, 59624}
        set ANSI bright yellow color to {55512, 55512, 55512}
        set ANSI bright blue color to {22616, 22616, 22616}
        set ANSI bright magenta color to {10280, 10280, 10280}
        set ANSI bright cyan color to {41377, 26985, 17990}
