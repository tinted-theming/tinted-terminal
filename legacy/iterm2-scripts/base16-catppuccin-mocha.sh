...
# Scheme name: Catppuccin Mocha (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {64250, 46003, 34695}
        set ANSI bright green color to {6168, 6168, 9509}
        set ANSI bright yellow color to {12593, 12850, 17476}
        set ANSI bright blue color to {22616, 23387, 28784}
        set ANSI bright magenta color to {62965, 57568, 56540}
        set ANSI bright cyan color to {62194, 52685, 52685}
