...
# Scheme name: Everforest Dark Hard (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {11822, 14392, 15420}
        set ANSI bright yellow color to {16705, 19275, 20560}
        set ANSI bright blue color to {40349, 43433, 41120}
        set ANSI bright magenta color to {60909, 60138, 56026}
