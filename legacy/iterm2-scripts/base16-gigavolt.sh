...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {6425, 63993, 34952}
        set ANSI bright green color to {11565, 12336, 15677}
        set ANSI bright yellow color to {23130, 22359, 28270}
        set ANSI bright blue color to {51914, 54227, 65535}
        set ANSI bright magenta color to {61423, 61680, 63993}
        set ANSI bright cyan color to {24929, 34695, 65535}
