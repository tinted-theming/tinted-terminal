...
# Scheme name: Synth Midnight Terminal Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {53199, 53713, 53970}
        set ANSI bright yellow color to {49601, 50115, 50372}
        set ANSI bright blue color to {18247, 18504, 18761}
        set ANSI bright magenta color to {6682, 6939, 7196}
