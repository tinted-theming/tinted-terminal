...
# Scheme name: Atelier Dune (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {10537, 10280, 9252}
        set ANSI bright yellow color to {28270, 27499, 24158}
        set ANSI bright blue color to {39321, 38293, 32896}
        set ANSI bright magenta color to {59624, 58596, 53199}
