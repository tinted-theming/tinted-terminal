...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {46003, 60395, 62194}
        set ANSI bright green color to {771, 5654, 6425}
        set ANSI bright yellow color to {1028, 7967, 8995}
        set ANSI bright blue color to {1542, 16448, 18504}
        set ANSI bright magenta color to {3084, 31868, 35980}
        set ANSI bright cyan color to {0, 38807, 42919}
