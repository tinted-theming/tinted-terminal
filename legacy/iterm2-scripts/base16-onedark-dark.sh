...
# Scheme name: OneDark Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {53713, 39578, 26214}
        set ANSI bright green color to {7196, 7967, 9252}
        set ANSI bright yellow color to {11308, 12593, 14906}
        set ANSI bright blue color to {22102, 23644, 25700}
        set ANSI bright magenta color to {46774, 48573, 51914}
        set ANSI bright cyan color to {48830, 20560, 17990}
