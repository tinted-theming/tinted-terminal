...
# Scheme name: Unikitty Reversible (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {19275, 18504, 20046}
        set ANSI bright yellow color to {26985, 26214, 27499}
        set ANSI bright blue color to {42405, 41891, 42662}
        set ANSI bright magenta color to {57825, 57568, 57825}
        set ANSI bright cyan color to {54484, 6682, 52685}
