...
# Scheme name: Atelier Dune Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {46774, 22102, 4369}
        set ANSI bright green color to {59624, 58596, 53199}
        set ANSI bright yellow color to {42662, 41634, 35980}
        set ANSI bright blue color to {32125, 31354, 26728}
        set ANSI bright magenta color to {10537, 10280, 9252}
        set ANSI bright cyan color to {54484, 13621, 21074}
