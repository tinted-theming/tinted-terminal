...
# Scheme name: Atelier Seaside Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {53199, 59624, 53199}
        set ANSI bright yellow color to {35980, 42662, 35980}
        set ANSI bright blue color to {26728, 32125, 26728}
        set ANSI bright magenta color to {9252, 10537, 9252}
