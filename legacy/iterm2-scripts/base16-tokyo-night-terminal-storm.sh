...
# Scheme name: Tokyo Night Terminal Storm (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 40606, 25700}
        set ANSI bright green color to {6682, 6939, 9766}
        set ANSI bright yellow color to {13364, 14906, 21074}
        set ANSI bright blue color to {30840, 31868, 39321}
        set ANSI bright magenta color to {52171, 52428, 53713}
        set ANSI bright cyan color to {53713, 34438, 5654}
