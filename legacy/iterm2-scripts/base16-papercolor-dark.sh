...
# Scheme name: PaperColor Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {24415, 44975, 24415}
        set ANSI bright green color to {44975, 0, 24415}
        set ANSI bright yellow color to {24415, 44975, 0}
        set ANSI bright blue color to {24415, 44975, 55255}
        set ANSI bright magenta color to {55255, 34695, 24415}
