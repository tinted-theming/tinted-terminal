...
# Scheme name: Oxocarbon Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {30840, 43433, 65535}
        set ANSI bright green color to {9766, 9766, 9766}
        set ANSI bright yellow color to {14649, 14649, 14649}
        set ANSI bright blue color to {56797, 57825, 59110}
        set ANSI bright magenta color to {65535, 65535, 65535}
        set ANSI bright cyan color to {33410, 53199, 65535}
