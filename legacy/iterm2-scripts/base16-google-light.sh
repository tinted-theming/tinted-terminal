...
# Scheme name: Google Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {63993, 27242, 14392}
        set ANSI bright green color to {57568, 57568, 57568}
        set ANSI bright yellow color to {50629, 51400, 50886}
        set ANSI bright blue color to {38550, 39064, 38550}
        set ANSI bright magenta color to {10280, 10794, 11822}
