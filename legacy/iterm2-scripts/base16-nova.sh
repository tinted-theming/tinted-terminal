...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {21845, 26728, 29555}
        ...
        set ANSI bright red color to {32639, 49601, 51914}
        set ANSI bright green color to {21845, 26728, 29555}
        set ANSI bright yellow color to {27242, 32125, 35209}
        set ANSI bright blue color to {35209, 39835, 42662}
        set ANSI bright magenta color to {35209, 39835, 42662}
