...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {60395, 47031, 37008}
        set ANSI bright green color to {62194, 61937, 62708}
        set ANSI bright yellow color to {55512, 54741, 56797}
        set ANSI bright blue color to {42405, 40349, 44975}
        set ANSI bright magenta color to {29298, 26471, 32382}
        set ANSI bright cyan color to {47802, 42405, 35980}
