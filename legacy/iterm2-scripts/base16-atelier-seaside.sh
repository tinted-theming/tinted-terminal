...
# Scheme name: Atelier Seaside (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {9252, 10537, 9252}
        ...
        set ANSI bright red color to {34695, 29041, 7453}
        set ANSI bright green color to {9252, 10537, 9252}
        set ANSI bright yellow color to {24158, 28270, 24158}
        set ANSI bright blue color to {32896, 39321, 32896}
        set ANSI bright magenta color to {53199, 59624, 53199}
        set ANSI bright cyan color to {59110, 6425, 50115}
