...
# Scheme name: Outrun Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {8224, 8224, 19018}
        ...
        set ANSI bright red color to {64764, 36237, 10280}
        set ANSI bright green color to {8224, 8224, 19018}
        set ANSI bright yellow color to {12336, 12336, 23130}
        set ANSI bright blue color to {45232, 45232, 56026}
        set ANSI bright magenta color to {57568, 57568, 65535}
        set ANSI bright cyan color to {61680, 771, 61423}
