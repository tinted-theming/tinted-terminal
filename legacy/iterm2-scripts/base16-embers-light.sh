...
# Scheme name: Embers Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {22359, 33410, 33410}
        set ANSI bright green color to {44718, 46774, 48830}
        set ANSI bright yellow color to {37008, 39578, 41891}
        set ANSI bright blue color to {18247, 20560, 23130}
        set ANSI bright magenta color to {8224, 9766, 11308}
        set ANSI bright cyan color to {22359, 22359, 33410}
