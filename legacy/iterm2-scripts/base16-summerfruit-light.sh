...
# Scheme name: Summerfruit Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65021, 35209, 0}
        set ANSI bright green color to {57568, 57568, 57568}
        set ANSI bright yellow color to {53456, 53456, 53456}
        set ANSI bright blue color to {0, 0, 0}
        set ANSI bright magenta color to {5397, 5397, 5397}
