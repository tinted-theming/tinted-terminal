...
# Scheme name: Precious Dark Eleven (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {10537, 11051, 11565}
        ...
        set ANSI bright red color to {60138, 38807, 21845}
        set ANSI bright green color to {10537, 11051, 11565}
        set ANSI bright yellow color to {14135, 14649, 14906}
        set ANSI bright blue color to {43176, 43176, 42919}
        set ANSI bright magenta color to {47288, 47031, 46774}
