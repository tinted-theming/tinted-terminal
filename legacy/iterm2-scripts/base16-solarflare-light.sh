...
# Scheme name: Solar Flare Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {59624, 59881, 60909}
        ...
        set ANSI bright green color to {59624, 59881, 60909}
        set ANSI bright yellow color to {42662, 44975, 47288}
        set ANSI bright blue color to {26214, 30069, 33153}
        set ANSI bright magenta color to {8738, 11822, 14392}
