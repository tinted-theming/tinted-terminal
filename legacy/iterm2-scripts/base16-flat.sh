...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {59110, 32382, 8738}
        set ANSI bright green color to {13364, 18761, 24158}
        set ANSI bright yellow color to {32639, 35980, 36237}
        set ANSI bright blue color to {48573, 50115, 51143}
