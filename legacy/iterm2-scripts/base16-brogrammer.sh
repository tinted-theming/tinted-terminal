...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {57054, 13621, 11822}
        set ANSI bright green color to {63736, 4369, 6168}
        set ANSI bright yellow color to {11565, 50629, 24158}
        set ANSI bright blue color to {10794, 33924, 53970}
        set ANSI bright magenta color to {4112, 33153, 54998}
        set ANSI bright cyan color to {65535, 65535, 65535}
