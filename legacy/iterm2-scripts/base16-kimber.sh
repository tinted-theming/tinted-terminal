...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {12593, 12593, 12593}
        ...
        set ANSI bright red color to {18247, 27756, 34952}
        set ANSI bright green color to {12593, 12593, 12593}
        set ANSI bright yellow color to {21845, 23901, 21845}
        set ANSI bright blue color to {23130, 23130, 23130}
        set ANSI bright magenta color to {50115, 50115, 46260}
        set ANSI bright cyan color to {28784, 20303, 20303}
