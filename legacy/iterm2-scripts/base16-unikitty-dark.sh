...
# Scheme name: Unikitty Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {19018, 17990, 19789}
        set ANSI bright yellow color to {26214, 25443, 26985}
        set ANSI bright blue color to {40863, 40349, 41634}
        set ANSI bright magenta color to {55512, 55255, 56026}
        set ANSI bright cyan color to {51143, 8224, 51914}
