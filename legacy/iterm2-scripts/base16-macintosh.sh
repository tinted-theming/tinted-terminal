...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 25700, 771}
        set ANSI bright green color to {16448, 16448, 16448}
        set ANSI bright yellow color to {16448, 16448, 16448}
        set ANSI bright blue color to {32896, 32896, 32896}
        set ANSI bright magenta color to {49344, 49344, 49344}
        set ANSI bright cyan color to {37008, 29041, 14906}
