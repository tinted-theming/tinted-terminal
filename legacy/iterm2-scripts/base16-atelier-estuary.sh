...
# Scheme name: Atelier Estuary (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {12336, 12079, 10023}
        ...
        set ANSI bright green color to {12336, 12079, 10023}
        set ANSI bright yellow color to {24415, 24158, 20046}
        set ANSI bright blue color to {34695, 34181, 29555}
        set ANSI bright magenta color to {59367, 59110, 57311}
