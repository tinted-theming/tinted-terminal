...
# Scheme name: Atelier Heath Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {55512, 51914, 55512}
        ...
        set ANSI bright red color to {42662, 22873, 9766}
        set ANSI bright green color to {55512, 51914, 55512}
        set ANSI bright yellow color to {43947, 39835, 43947}
        set ANSI bright blue color to {30583, 26985, 30583}
        set ANSI bright magenta color to {10537, 8995, 10537}
        set ANSI bright cyan color to {52428, 13107, 52428}
