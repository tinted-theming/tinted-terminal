...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 41120, 26214}
        set ANSI bright green color to {5654, 5654, 7453}
        set ANSI bright yellow color to {8738, 12850, 18761}
        set ANSI bright blue color to {29298, 29041, 26985}
        set ANSI bright magenta color to {51400, 49344, 37779}
        set ANSI bright cyan color to {53970, 32382, 39321}
