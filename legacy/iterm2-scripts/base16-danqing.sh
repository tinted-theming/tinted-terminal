...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {17219, 18504, 17990}
        ...
        set ANSI bright green color to {17219, 18504, 17990}
        set ANSI bright yellow color to {23130, 24672, 23901}
        set ANSI bright blue color to {51914, 55512, 53970}
        set ANSI bright magenta color to {60652, 63222, 62194}
