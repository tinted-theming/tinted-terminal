...
# Scheme name: Catppuccin Macchiato (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {62965, 43433, 32639}
        set ANSI bright green color to {7710, 8224, 12336}
        set ANSI bright yellow color to {13878, 14906, 20303}
        set ANSI bright blue color to {23387, 24672, 30840}
        set ANSI bright magenta color to {62708, 56283, 54998}
        set ANSI bright cyan color to {61680, 50886, 50886}
