...
# Scheme name: Heetch Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {23387, 41634, 46774}
        set ANSI bright green color to {14649, 9509, 20817}
        set ANSI bright yellow color to {23130, 18761, 28270}
        set ANSI bright blue color to {40092, 37522, 43176}
        set ANSI bright magenta color to {57054, 56026, 58082}
        set ANSI bright cyan color to {18247, 1285, 17990}
