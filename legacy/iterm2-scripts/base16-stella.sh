...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {13878, 11051, 18504}
        ...
        set ANSI bright red color to {34952, 25957, 50886}
        set ANSI bright green color to {13878, 11051, 18504}
        set ANSI bright yellow color to {19789, 16705, 24672}
        set ANSI bright blue color to {32639, 29041, 37522}
        set ANSI bright magenta color to {46260, 42405, 51400}
        set ANSI bright cyan color to {51143, 43947, 34695}
