...
# Scheme name: Measured Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {56540, 41891, 31868}
        set ANSI bright green color to {0, 14906, 14392}
        set ANSI bright yellow color to {0, 21588, 21331}
        set ANSI bright blue color to {50115, 50115, 50115}
        set ANSI bright magenta color to {61423, 61423, 61423}
        set ANSI bright cyan color to {55512, 39578, 47802}
