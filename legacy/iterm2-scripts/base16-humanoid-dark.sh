...
# Scheme name: Humanoid dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 38293, 1285}
        set ANSI bright green color to {13107, 15163, 15677}
        set ANSI bright yellow color to {18504, 20046, 21588}
        set ANSI bright blue color to {49344, 49344, 48573}
        set ANSI bright magenta color to {64764, 64764, 63222}
        set ANSI bright cyan color to {45746, 30583, 257}
