...
# Scheme name: Atelier Cave (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {9766, 8995, 10794}
        set ANSI bright yellow color to {22616, 21074, 24672}
        set ANSI bright blue color to {32382, 30840, 34695}
        set ANSI bright magenta color to {58082, 57311, 59367}
