...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {16705, 12850, 16191}
        ...
        set ANSI bright red color to {63993, 39835, 5397}
        set ANSI bright green color to {16705, 12850, 16191}
        set ANSI bright yellow color to {20303, 16962, 19532}
        set ANSI bright blue color to {36237, 34438, 34695}
        set ANSI bright magenta color to {47545, 46774, 45232}
        set ANSI bright cyan color to {59881, 27499, 43176}
