...
# Scheme name: Precious Dark Fifteen (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {12336, 13107, 14135}
        ...
        set ANSI bright red color to {59881, 39064, 22359}
        set ANSI bright green color to {12336, 13107, 14135}
        set ANSI bright yellow color to {15934, 16448, 17476}
        set ANSI bright blue color to {43947, 43690, 43176}
        set ANSI bright magenta color to {47802, 47545, 46774}
        set ANSI bright cyan color to {62451, 33410, 55512}
