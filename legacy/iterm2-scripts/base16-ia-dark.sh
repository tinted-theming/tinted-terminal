...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {55512, 26728, 26728}
        set ANSI bright green color to {8738, 8738, 8738}
        set ANSI bright yellow color to {7453, 16705, 19789}
