...
# Scheme name: Harmonic16 Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {49087, 49087, 22102}
        set ANSI bright green color to {58853, 60395, 61937}
        set ANSI bright yellow color to {52171, 54998, 58082}
        set ANSI bright blue color to {25186, 32382, 39321}
        set ANSI bright magenta color to {8738, 15163, 21588}
        set ANSI bright cyan color to {49087, 22102, 22102}
