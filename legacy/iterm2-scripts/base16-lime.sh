...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {8224, 8224, 12336}
        ...
        set ANSI bright red color to {65535, 30583, 14906}
        set ANSI bright green color to {8224, 8224, 12336}
        set ANSI bright yellow color to {10794, 10794, 16191}
        set ANSI bright blue color to {20817, 20817, 21845}
        set ANSI bright magenta color to {65535, 62194, 53713}
        set ANSI bright cyan color to {46260, 55769, 31868}
