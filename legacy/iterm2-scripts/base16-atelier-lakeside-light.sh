...
# Scheme name: Atelier Lakeside Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {49601, 58596, 63222}
        ...
        set ANSI bright red color to {37779, 23644, 9509}
        set ANSI bright green color to {49601, 58596, 63222}
        set ANSI bright yellow color to {32382, 41634, 46260}
        set ANSI bright blue color to {23130, 31611, 35980}
        set ANSI bright magenta color to {7967, 10537, 11822}
        set ANSI bright cyan color to {47031, 11565, 53970}
