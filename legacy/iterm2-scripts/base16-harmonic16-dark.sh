...
# Scheme name: Harmonic16 Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {8738, 15163, 21588}
        set ANSI bright yellow color to {16448, 23644, 31097}
        set ANSI bright blue color to {43690, 48316, 52942}
        set ANSI bright magenta color to {58853, 60395, 61937}
