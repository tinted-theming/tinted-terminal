...
# Scheme name: Purpledream (legacy)
# Scheme author: malet
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {52428, 44718, 5140}
        set ANSI bright green color to {12336, 8224, 12336}
        set ANSI bright yellow color to {16448, 12336, 16448}
        set ANSI bright blue color to {48059, 45232, 48059}
        set ANSI bright magenta color to {61166, 57568, 61166}
        set ANSI bright cyan color to {27242, 10794, 15420}
