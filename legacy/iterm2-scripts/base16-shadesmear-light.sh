...
# Scheme name: ShadeSmear Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {58596, 58596, 58596}
        set ANSI bright yellow color to {49344, 49344, 49344}
        set ANSI bright blue color to {7196, 7196, 7196}
        set ANSI bright magenta color to {7196, 7196, 7196}
