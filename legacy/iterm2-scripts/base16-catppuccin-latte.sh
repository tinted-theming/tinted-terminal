...
# Scheme name: Catppuccin Latte (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65278, 25700, 2827}
        set ANSI bright green color to {59110, 59881, 61423}
        set ANSI bright yellow color to {52428, 53456, 56026}
        set ANSI bright blue color to {44204, 45232, 48830}
        set ANSI bright magenta color to {56540, 35466, 30840}
        set ANSI bright cyan color to {56797, 30840, 30840}
