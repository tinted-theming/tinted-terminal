...
# Scheme name: PaperColor Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {44975, 0, 0}
        set ANSI bright yellow color to {0, 34695, 0}
        set ANSI bright blue color to {0, 34695, 44975}
        set ANSI bright magenta color to {0, 24415, 34695}
        set ANSI bright cyan color to {0, 24415, 34695}
