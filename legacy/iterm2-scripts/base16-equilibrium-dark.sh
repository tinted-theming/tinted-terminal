...
# Scheme name: Equilibrium Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {6168, 7196, 8738}
        ...
        set ANSI bright red color to {57311, 22873, 8995}
        set ANSI bright green color to {6168, 7196, 8738}
        set ANSI bright yellow color to {8738, 9766, 11565}
        set ANSI bright blue color to {38036, 37008, 34952}
        set ANSI bright magenta color to {51914, 50886, 48573}
        set ANSI bright cyan color to {58339, 18504, 36494}
