...
# Scheme name: Tokyo City Terminal Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {63222, 63222, 63736}
        set ANSI bright yellow color to {55512, 58082, 60652}
        set ANSI bright blue color to {21074, 25186, 28784}
        set ANSI bright magenta color to {7453, 9509, 11308}
        set ANSI bright cyan color to {32382, 20817, 16448}
