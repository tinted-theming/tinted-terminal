...
# Scheme name: Tomorrow Night (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {57054, 37779, 24415}
        set ANSI bright green color to {10280, 10794, 11822}
        set ANSI bright yellow color to {14135, 15163, 16705}
