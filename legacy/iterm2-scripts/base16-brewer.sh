...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {59110, 21845, 3341}
        set ANSI bright green color to {11822, 12079, 12336}
        set ANSI bright yellow color to {20817, 21074, 21331}
        set ANSI bright blue color to {38293, 38550, 38807}
        set ANSI bright magenta color to {56026, 56283, 56540}
        set ANSI bright cyan color to {45489, 22873, 10280}
