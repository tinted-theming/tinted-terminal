...
# Scheme name: Measured Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {63993, 62965, 61937}
        ...
        set ANSI bright red color to {44461, 22102, 257}
        set ANSI bright green color to {63993, 62965, 61937}
        set ANSI bright yellow color to {65535, 60138, 56026}
        set ANSI bright blue color to {16448, 16448, 16448}
        set ANSI bright magenta color to {6168, 6168, 6168}
        set ANSI bright cyan color to {43176, 6682, 26214}
