...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {51143, 51143, 38293}
        set ANSI bright green color to {14649, 16191, 17733}
        set ANSI bright yellow color to {22102, 24158, 25957}
        set ANSI bright blue color to {44461, 46003, 47802}
        set ANSI bright magenta color to {57311, 58082, 58853}
        set ANSI bright cyan color to {51143, 38293, 38293}
