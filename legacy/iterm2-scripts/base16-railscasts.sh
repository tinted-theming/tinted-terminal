...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {52428, 30840, 13107}
        set ANSI bright green color to {10023, 10537, 13621}
        set ANSI bright yellow color to {14906, 16448, 21845}
        set ANSI bright blue color to {54484, 53199, 51657}
        set ANSI bright magenta color to {62708, 61937, 60909}
        set ANSI bright cyan color to {48316, 38036, 22616}
