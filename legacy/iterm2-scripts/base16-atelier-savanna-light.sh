...
# Scheme name: Atelier Savanna Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {57311, 59367, 58082}
        ...
        set ANSI bright green color to {57311, 59367, 58082}
        set ANSI bright yellow color to {34695, 37522, 35466}
        set ANSI bright blue color to {24415, 28013, 25700}
        set ANSI bright magenta color to {8995, 10794, 9509}
