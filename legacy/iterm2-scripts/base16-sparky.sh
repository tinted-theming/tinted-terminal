...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 36751, 7196}
        set ANSI bright green color to {0, 12593, 15420}
        set ANSI bright yellow color to {0, 15420, 17990}
        set ANSI bright blue color to {0, 30583, 35723}
        set ANSI bright magenta color to {62965, 62965, 61937}
        set ANSI bright cyan color to {39835, 28784, 19789}
