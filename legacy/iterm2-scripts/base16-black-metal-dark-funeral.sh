...
# Scheme name: Black Metal (Dark Funeral) (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {43690, 43690, 43690}
        set ANSI bright green color to {4626, 4626, 4626}
        ...
        set ANSI bright cyan color to {17476, 17476, 17476}
