...
# Scheme name: Horizon Terminal Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {64250, 47031, 38293}
        set ANSI bright green color to {8995, 9509, 12336}
        set ANSI bright yellow color to {11822, 12336, 15934}
        set ANSI bright blue color to {40349, 41120, 41634}
        set ANSI bright magenta color to {56540, 57311, 58596}
        set ANSI bright cyan color to {61680, 37779, 33667}
