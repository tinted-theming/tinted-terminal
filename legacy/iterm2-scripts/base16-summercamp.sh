...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {64507, 41377, 6939}
        set ANSI bright green color to {10794, 9766, 7196}
        set ANSI bright yellow color to {14906, 13621, 10023}
        set ANSI bright blue color to {24415, 23387, 17733}
        set ANSI bright magenta color to {47802, 46774, 38550}
        set ANSI bright cyan color to {63222, 39835, 59367}
