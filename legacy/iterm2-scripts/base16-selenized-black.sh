...
# Scheme name: selenized-black (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {59110, 32639, 17219}
        set ANSI bright green color to {9509, 9509, 9509}
        set ANSI bright yellow color to {15163, 15163, 15163}
        set ANSI bright blue color to {30583, 30583, 30583}
        set ANSI bright magenta color to {57054, 57054, 57054}
        set ANSI bright cyan color to {60395, 28270, 47031}
