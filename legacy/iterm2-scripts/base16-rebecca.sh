...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {26214, 13107, 39321}
        ...
        set ANSI bright red color to {61423, 58596, 41377}
        set ANSI bright green color to {26214, 13107, 39321}
        set ANSI bright yellow color to {14392, 14906, 25186}
        set ANSI bright blue color to {41120, 41120, 50629}
        set ANSI bright magenta color to {52428, 52428, 65535}
        set ANSI bright cyan color to {65535, 31097, 50886}
