...
# Scheme name: Rosé Pine Moon (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {63222, 49601, 30583}
        set ANSI bright green color to {10794, 10023, 16191}
        set ANSI bright yellow color to {14649, 13621, 21074}
        set ANSI bright blue color to {37008, 35980, 43690}
        set ANSI bright magenta color to {57568, 57054, 62708}
        set ANSI bright cyan color to {22102, 21074, 28270}
