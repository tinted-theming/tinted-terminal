...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {63736, 58082, 59367}
        ...
        set ANSI bright red color to {63222, 26214, 7710}
        set ANSI bright green color to {63736, 58082, 59367}
        set ANSI bright yellow color to {57568, 52428, 53713}
        set ANSI bright blue color to {26214, 20560, 21845}
        set ANSI bright magenta color to {16962, 14392, 14906}
        set ANSI bright cyan color to {47802, 3341, 13621}
