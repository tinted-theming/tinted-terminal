...
# Scheme name: Rosé Pine Dawn (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {60138, 40349, 13364}
        set ANSI bright green color to {65535, 64250, 62451}
        set ANSI bright yellow color to {62194, 59881, 57054}
        set ANSI bright blue color to {31097, 30069, 37779}
        set ANSI bright magenta color to {22359, 21074, 31097}
        set ANSI bright cyan color to {52942, 51914, 52685}
