...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {10794, 13364, 18504}
        ...
        set ANSI bright red color to {61680, 41120, 0}
        set ANSI bright green color to {10794, 13364, 18504}
        set ANSI bright yellow color to {19789, 22102, 26214}
        set ANSI bright blue color to {39578, 39321, 41891}
        set ANSI bright magenta color to {56283, 56797, 57568}
        set ANSI bright cyan color to {45232, 32896, 24672}
