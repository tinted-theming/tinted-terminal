...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {7967, 7453, 11822}
        set ANSI bright yellow color to {9766, 8995, 14906}
        set ANSI bright blue color to {37008, 35980, 43690}
        set ANSI bright magenta color to {57568, 57054, 62708}
        set ANSI bright cyan color to {21074, 20303, 26471}
