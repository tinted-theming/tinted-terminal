...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {64764, 43947, 29812}
        set ANSI bright green color to {7453, 18761, 20046}
        set ANSI bright yellow color to {10794, 20560, 21588}
        set ANSI bright blue color to {40349, 51400, 52685}
        set ANSI bright magenta color to {52171, 62194, 63479}
        set ANSI bright cyan color to {39835, 25700, 31611}
