...
# Scheme name: Tokyodark Terminal (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {63222, 38293, 23387}
        set ANSI bright green color to {6682, 6939, 10794}
        set ANSI bright yellow color to {8481, 8738, 13364}
        set ANSI bright blue color to {19018, 20560, 22359}
        set ANSI bright magenta color to {41120, 43176, 52685}
        set ANSI bright cyan color to {30583, 13364, 16448}
