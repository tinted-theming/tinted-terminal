...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {14392, 14392, 14392}
        set ANSI bright yellow color to {18504, 18504, 18504}
        set ANSI bright blue color to {47288, 47288, 47288}
