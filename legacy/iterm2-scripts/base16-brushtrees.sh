...
# Scheme name: Brush Trees (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {51657, 56283, 56540}
        ...
        set ANSI bright red color to {55512, 48059, 41634}
        set ANSI bright green color to {51657, 56283, 56540}
        set ANSI bright yellow color to {45232, 50629, 51400}
        set ANSI bright blue color to {33410, 39321, 41377}
        set ANSI bright magenta color to {23130, 28013, 31354}
        set ANSI bright cyan color to {46003, 40863, 40863}
