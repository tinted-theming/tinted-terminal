...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {57568, 57054, 57568}
        ...
        set ANSI bright red color to {65278, 28013, 2056}
        set ANSI bright green color to {57568, 57054, 57568}
        set ANSI bright yellow color to {55512, 54741, 54741}
        set ANSI bright blue color to {38807, 38293, 39064}
        set ANSI bright magenta color to {18247, 17733, 17733}
        set ANSI bright cyan color to {45489, 28527, 16448}
