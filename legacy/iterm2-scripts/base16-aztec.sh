...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {61166, 34952, 0}
        set ANSI bright green color to {6682, 7710, 257}
        set ANSI bright yellow color to {9252, 9766, 1028}
        set ANSI bright blue color to {65535, 53713, 10537}
        set ANSI bright magenta color to {65535, 57825, 30840}
        set ANSI bright cyan color to {43433, 10280, 47545}
