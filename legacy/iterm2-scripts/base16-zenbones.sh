...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {57054, 28270, 31868}
        ...
        set ANSI bright red color to {59624, 33667, 36751}
        set ANSI bright green color to {57054, 28270, 31868}
        set ANSI bright yellow color to {33153, 39835, 26985}
        set ANSI bright blue color to {24672, 39321, 49344}
        set ANSI bright magenta color to {26214, 42405, 44461}
        set ANSI bright cyan color to {36494, 36494, 36494}
