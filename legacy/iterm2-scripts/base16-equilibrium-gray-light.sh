...
# Scheme name: Equilibrium Gray Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {58082, 58082, 58082}
        set ANSI bright yellow color to {54484, 54484, 54484}
        set ANSI bright blue color to {24158, 24158, 24158}
        set ANSI bright magenta color to {12336, 12336, 12336}
