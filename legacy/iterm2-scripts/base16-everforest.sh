...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {13364, 16191, 17476}
        ...
        set ANSI bright red color to {59110, 39064, 30069}
        set ANSI bright green color to {13364, 16191, 17476}
        set ANSI bright yellow color to {18247, 21074, 22616}
        set ANSI bright blue color to {40349, 43433, 41120}
        set ANSI bright magenta color to {59110, 58082, 52428}
        set ANSI bright cyan color to {40349, 43433, 41120}
