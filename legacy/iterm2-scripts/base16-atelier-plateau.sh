...
# Scheme name: Atelier Plateau (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {10537, 9252, 9252}
        ...
        set ANSI bright red color to {46260, 23130, 15420}
        set ANSI bright green color to {10537, 9252, 9252}
        set ANSI bright yellow color to {22616, 20560, 20560}
        set ANSI bright blue color to {32382, 30583, 30583}
        set ANSI bright magenta color to {59367, 57311, 57311}
        set ANSI bright cyan color to {48573, 20817, 34695}
