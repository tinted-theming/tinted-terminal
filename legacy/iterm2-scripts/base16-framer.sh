...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {64764, 18247, 26985}
        set ANSI bright green color to {5397, 5397, 5397}
        set ANSI bright yellow color to {17990, 17990, 17990}
        set ANSI bright blue color to {47545, 47545, 47545}
        set ANSI bright magenta color to {59624, 59624, 59624}
        set ANSI bright cyan color to {45489, 24415, 19018}
