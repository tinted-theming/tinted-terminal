...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {53456, 34695, 28784}
        set ANSI bright green color to {13364, 15677, 17990}
        set ANSI bright yellow color to {20303, 23387, 26214}
        set ANSI bright blue color to {42919, 44461, 47802}
        set ANSI bright magenta color to {57311, 57825, 59624}
        set ANSI bright cyan color to {43947, 31097, 26471}
