...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {48573, 26985, 16962}
        set ANSI bright green color to {57311, 54998, 53713}
        set ANSI bright yellow color to {53456, 49601, 48059}
        set ANSI bright blue color to {22873, 17733, 15677}
        set ANSI bright magenta color to {13621, 10794, 9509}
        set ANSI bright cyan color to {45232, 29041, 22616}
