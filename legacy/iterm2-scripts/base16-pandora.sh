...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 37265, 21331}
        set ANSI bright green color to {12079, 6168, 8995}
        set ANSI bright yellow color to {18247, 8738, 13364}
        set ANSI bright blue color to {39835, 10794, 17990}
        set ANSI bright magenta color to {33153, 20560, 27242}
        set ANSI bright cyan color to {41634, 16448, 12336}
