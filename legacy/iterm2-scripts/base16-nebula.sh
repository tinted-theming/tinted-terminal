...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {38036, 37522, 40606}
        set ANSI bright green color to {16705, 20303, 24672}
        set ANSI bright yellow color to {23130, 33667, 32896}
        set ANSI bright blue color to {34695, 34952, 35723}
        set ANSI bright magenta color to {51143, 51657, 52685}
        set ANSI bright cyan color to {35980, 28784, 42919}
