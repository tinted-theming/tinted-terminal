...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {34181, 65535, 57568}
        set ANSI bright green color to {8738, 9766, 11565}
        set ANSI bright yellow color to {15420, 16191, 19532}
        set ANSI bright blue color to {21845, 24158, 28784}
        set ANSI bright magenta color to {45746, 49087, 55769}
        set ANSI bright cyan color to {65535, 15677, 33153}
