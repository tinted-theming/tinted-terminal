...
# Scheme name: Material Palenight (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {17476, 16962, 26471}
        set ANSI bright yellow color to {12850, 14135, 19789}
        set ANSI bright blue color to {34695, 38550, 45232}
        set ANSI bright magenta color to {38293, 40349, 52171}
