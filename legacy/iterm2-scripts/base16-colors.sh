...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 34181, 6939}
        set ANSI bright green color to {13107, 13107, 13107}
        set ANSI bright yellow color to {21845, 21845, 21845}
        set ANSI bright blue color to {39321, 39321, 39321}
        set ANSI bright magenta color to {56797, 56797, 56797}
        set ANSI bright cyan color to {34181, 5140, 19275}
