...
# Scheme name: selenized-white (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {47802, 14135, 0}
        set ANSI bright green color to {60395, 60395, 60395}
        set ANSI bright yellow color to {52685, 52685, 52685}
        set ANSI bright blue color to {34695, 34695, 34695}
        set ANSI bright magenta color to {10280, 10280, 10280}
        set ANSI bright cyan color to {56797, 3855, 40349}
