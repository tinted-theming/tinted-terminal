...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 39321, 26214}
        set ANSI bright green color to {15677, 22102, 28527}
        set ANSI bright yellow color to {19275, 26985, 34952}
        set ANSI bright blue color to {32382, 37008, 41891}
        set ANSI bright magenta color to {54998, 55255, 55769}
        set ANSI bright cyan color to {48059, 25700, 43433}
