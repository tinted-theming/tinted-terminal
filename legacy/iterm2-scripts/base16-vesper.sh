...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {56026, 45232, 33667}
        set ANSI bright green color to {8995, 8995, 8995}
        set ANSI bright yellow color to {8738, 8738, 8738}
        set ANSI bright blue color to {39321, 39321, 39321}
        set ANSI bright magenta color to {49601, 49601, 49601}
        set ANSI bright cyan color to {34695, 27756, 20303}
