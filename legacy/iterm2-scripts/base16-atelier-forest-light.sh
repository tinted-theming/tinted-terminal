...
# Scheme name: Atelier Forest Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {59110, 58082, 57568}
        ...
        set ANSI bright green color to {59110, 58082, 57568}
        set ANSI bright yellow color to {43176, 41377, 40863}
        set ANSI bright blue color to {30326, 28270, 27499}
        set ANSI bright magenta color to {11308, 9252, 8481}
