...
# Scheme name: Green Screen (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {0, 39321, 0}
        set ANSI bright green color to {0, 13107, 0}
        set ANSI bright yellow color to {0, 21845, 0}
        set ANSI bright blue color to {0, 39321, 0}
        set ANSI bright magenta color to {0, 56797, 0}
