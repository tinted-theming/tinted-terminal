...
# Scheme name: Blue Forest (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {7710, 23644, 7710}
        ...
        set ANSI bright green color to {7710, 23644, 7710}
        set ANSI bright yellow color to {10023, 15934, 23644}
        set ANSI bright blue color to {7710, 23644, 7710}
        set ANSI bright magenta color to {37265, 52428, 65535}
        set ANSI bright cyan color to {59367, 59367, 59367}
