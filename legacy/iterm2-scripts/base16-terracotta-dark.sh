...
# Scheme name: Terracotta Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 43176, 34952}
        set ANSI bright green color to {13878, 11051, 10023}
        set ANSI bright yellow color to {18247, 14649, 13107}
        set ANSI bright blue color to {42919, 36494, 33924}
        set ANSI bright magenta color to {51914, 48059, 46517}
        set ANSI bright cyan color to {61937, 44718, 38807}
