...
# Scheme name: Dark Violet (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {48059, 26214, 52428}
        set ANSI bright green color to {8995, 6682, 16448}
        set ANSI bright yellow color to {17219, 11565, 22873}
        set ANSI bright blue color to {0, 65535, 0}
        set ANSI bright magenta color to {37008, 17733, 59110}
        set ANSI bright cyan color to {43176, 34438, 49087}
