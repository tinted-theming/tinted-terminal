...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {33410, 33410, 22359}
        set ANSI bright green color to {11308, 9766, 8224}
        set ANSI bright yellow color to {17219, 15163, 12850}
        set ANSI bright blue color to {35466, 32896, 30069}
        set ANSI bright magenta color to {48830, 46774, 44718}
        set ANSI bright cyan color to {33410, 22359, 22359}
