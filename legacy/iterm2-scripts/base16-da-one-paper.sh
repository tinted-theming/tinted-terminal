...
# Scheme name: Da One Paper (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {51400, 51400, 51400}
        ...
        set ANSI bright red color to {65535, 38036, 28784}
        set ANSI bright green color to {51400, 51400, 51400}
        set ANSI bright yellow color to {34952, 34952, 34952}
        set ANSI bright blue color to {10280, 10280, 10280}
        set ANSI bright magenta color to {0, 0, 0}
