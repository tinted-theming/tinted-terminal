...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {19275, 45489, 42919}
        set ANSI bright green color to {8224, 8224, 8224}
        set ANSI bright yellow color to {12336, 12336, 12336}
        set ANSI bright blue color to {20560, 20560, 20560}
        set ANSI bright magenta color to {32896, 32896, 32896}
        set ANSI bright cyan color to {47288, 34952, 58082}
