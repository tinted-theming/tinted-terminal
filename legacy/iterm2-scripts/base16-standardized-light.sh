...
# Scheme name: standardized-light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {55255, 26985, 7453}
        set ANSI bright green color to {61166, 61166, 61166}
        set ANSI bright yellow color to {52428, 52428, 52428}
        set ANSI bright blue color to {30326, 30326, 30326}
        set ANSI bright magenta color to {13107, 13107, 13107}
        set ANSI bright cyan color to {35209, 20560, 9509}
