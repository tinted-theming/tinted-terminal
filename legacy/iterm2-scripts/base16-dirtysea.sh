...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {0, 25957, 25957}
        set ANSI bright green color to {53456, 56026, 53456}
        set ANSI bright yellow color to {53456, 53456, 53456}
        set ANSI bright blue color to {8224, 8224, 8224}
        set ANSI bright magenta color to {63736, 63736, 63736}
