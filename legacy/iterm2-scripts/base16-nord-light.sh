...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {49858, 53456, 59367}
        ...
        set ANSI bright red color to {44204, 17476, 9766}
        set ANSI bright green color to {49858, 53456, 59367}
        set ANSI bright yellow color to {47288, 50629, 56283}
        set ANSI bright blue color to {24672, 29298, 35980}
        set ANSI bright magenta color to {15163, 16962, 21074}
        set ANSI bright cyan color to {21074, 29298, 44975}
