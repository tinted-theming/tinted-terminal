...
# Scheme name: Primer Dark Dimmed (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {57568, 33410, 15677}
        set ANSI bright green color to {14135, 15934, 18247}
        set ANSI bright yellow color to {17476, 19532, 22102}
        set ANSI bright blue color to {30326, 33667, 37008}
        set ANSI bright magenta color to {44461, 47802, 51143}
        set ANSI bright cyan color to {44718, 22102, 8738}
