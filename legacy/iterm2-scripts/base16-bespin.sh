...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {13878, 12593, 11822}
        ...
        set ANSI bright red color to {53199, 32125, 13364}
        set ANSI bright green color to {13878, 12593, 11822}
        set ANSI bright yellow color to {24158, 23901, 23644}
        set ANSI bright blue color to {31097, 31097, 30583}
        set ANSI bright magenta color to {40349, 39835, 38807}
        set ANSI bright cyan color to {37779, 29041, 8481}
