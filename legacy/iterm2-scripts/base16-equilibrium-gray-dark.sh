...
# Scheme name: Equilibrium Gray Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {6939, 6939, 6939}
        set ANSI bright yellow color to {9766, 9766, 9766}
        set ANSI bright blue color to {37265, 37265, 37265}
        set ANSI bright magenta color to {50886, 50886, 50886}
