...
# Scheme name: Solarized Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {1799, 13878, 16962}
        set ANSI bright yellow color to {22616, 28270, 30069}
        set ANSI bright blue color to {33667, 38036, 38550}
        set ANSI bright magenta color to {61166, 59624, 54741}
