...
# Scheme name: Heetch Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {48573, 46774, 50629}
        set ANSI bright green color to {14649, 9509, 20817}
        set ANSI bright yellow color to {31611, 28013, 35723}
        set ANSI bright blue color to {56797, 54998, 58853}
        set ANSI bright magenta color to {18247, 1285, 17990}
        set ANSI bright cyan color to {57054, 56026, 58082}
