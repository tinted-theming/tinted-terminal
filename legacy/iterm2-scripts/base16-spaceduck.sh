...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {58339, 38036, 0}
        set ANSI bright green color to {6939, 7196, 13878}
        set ANSI bright yellow color to {12336, 13878, 24415}
        set ANSI bright blue color to {33153, 34181, 38550}
        set ANSI bright magenta color to {49601, 50115, 52428}
        set ANSI bright cyan color to {52942, 28527, 36751}
