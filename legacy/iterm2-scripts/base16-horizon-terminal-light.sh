...
# Scheme name: Horizon Terminal Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {63993, 52942, 50115}
        set ANSI bright green color to {64250, 56026, 53713}
        set ANSI bright yellow color to {63993, 52171, 48830}
        set ANSI bright blue color to {38036, 35980, 35466}
        set ANSI bright magenta color to {12336, 11308, 11565}
        set ANSI bright cyan color to {63993, 52171, 48830}
