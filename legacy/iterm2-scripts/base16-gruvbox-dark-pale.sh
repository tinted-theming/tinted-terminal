...
# Scheme name: Gruvbox dark, pale (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {14906, 14906, 14906}
        ...
        set ANSI bright green color to {14906, 14906, 14906}
        set ANSI bright yellow color to {20046, 20046, 20046}
        set ANSI bright blue color to {38036, 38036, 38036}
