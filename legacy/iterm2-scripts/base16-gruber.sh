...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {51143, 15420, 16191}
        set ANSI bright green color to {17733, 15677, 16705}
        set ANSI bright yellow color to {18504, 18504, 18504}
        set ANSI bright blue color to {58596, 58596, 61423}
        set ANSI bright magenta color to {62965, 62965, 62965}
        set ANSI bright cyan color to {52428, 35980, 15420}
