...
# Scheme name: Gruvbox Material Light, Hard (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {64507, 61937, 51143}
        set ANSI bright yellow color to {57568, 53199, 43433}
        set ANSI bright blue color to {51657, 47545, 39578}
