...
# Scheme name: Atelier Plateau Light (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {59367, 57311, 57311}
        set ANSI bright yellow color to {35466, 34181, 34181}
        set ANSI bright blue color to {25957, 23901, 23901}
        set ANSI bright magenta color to {10537, 9252, 9252}
