...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {42662, 13878, 20560}
        set ANSI bright green color to {14906, 9252, 9509}
        set ANSI bright yellow color to {22102, 14392, 14135}
        set ANSI bright blue color to {35723, 23901, 22359}
        set ANSI bright magenta color to {50629, 36237, 31611}
        set ANSI bright cyan color to {35209, 16191, 17733}
