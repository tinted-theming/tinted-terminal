...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {48830, 48830, 53970}
        ...
        set ANSI bright red color to {53970, 10794, 35723}
        set ANSI bright green color to {48830, 48830, 53970}
        set ANSI bright yellow color to {40606, 40606, 44975}
        set ANSI bright blue color to {20560, 20560, 25443}
        set ANSI bright magenta color to {8738, 8738, 14906}
        set ANSI bright cyan color to {36237, 5911, 42405}
