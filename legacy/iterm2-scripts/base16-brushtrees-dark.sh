...
# Scheme name: Brush Trees Dark (legacy)
...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {23130, 28013, 31354}
        set ANSI bright yellow color to {28013, 33410, 36494}
        set ANSI bright blue color to {39064, 44975, 46517}
        set ANSI bright magenta color to {51657, 56283, 56540}
